...
if st.button("Prédire"):
    ...
    """
    st.write(input_data_json)
    # Envoyer la requête à votre API Flask en utilisant le JSON
    response = requests.post('http://localhost:5000/predict', json={'data': input_data_json})
